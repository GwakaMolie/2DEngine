...
void LevelParser::parseTextures(TiXmlElement* pTextureRoot) {
    ...
    TheTextureManager::Instance()->LoadTexture(pTextureRoot->Attribute("value"), pTextureRoot->Attribute("name"));
}

Level* LevelParser::parseLevel(const char* levelFile){
    //create a tinyxml doc and load the xml map
...
void LevelParser::parseTilesets(TiXmlElement* pTilesetRoot, std::vector<Tileset> *pTilesets){
    ...
    TheTextureManager::Instance()->LoadTexture(pTilesetRoot->FirstChildElement()->Attribute("source"), 
